  ...
  const handleNavClick = (sectionId) => {
    ...
    switch (sectionId) {
      ...
      case 'activities':
        ...
        break;
      case 'events':
        scrollTarget = viewportHeight * 7.7; // Correspond à App.js
        break;
      case 'contact':
        scrollTarget = viewportHeight * 10.2; // Correspond à App.js
        break;
      case 'membership':
        scrollTarget = viewportHeight * 12; // Correspond à App.js
        break;
      default:
        scrollTarget = 0;
    }
