...
const InscriptionPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.university.trim()) newErrors.university = 'L\'établissement est requis';
    if (!formData.level) newErrors.level = 'Le niveau d\'études est requis';
    if (!formData.field.trim()) newErrors.field = 'La filière est requise';
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-rajdhani text-lg text-gray-300 max-w-2xl mx-auto">
            Remplissez ce formulaire pour devenir membre du club AIS et accéder à un écosystème 
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block font-rajdhani text-gray-300 mb-2">Date de Naissance *</label>
                  <input
                    type="date"
                    name="dateOfBirth"
                    ...
                    className={`w-full bg-black/30 border rounded-lg px-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 transition-all duration-300 ${
                      errors.dateOfBirth ? 'border-red-400 focus:ring-red-400/50' : 'border-cyber-blue/30 focus:ring-cyber-blue/50 focus:border-cyber-blue'
                    }`}
                  />
                  {errors.dateOfBirth && <span className="text-red-400 text-sm font-rajdhani mt-1 block">{errors.dateOfBirth}</span>}
                </div>

                <div>
                  <label className="block font-rajdhani text-gray-300 mb-2">Ville</label>
                  <input
                    type="text"
                    name="city"
                    value={formData.city}
                    onChange={handleInputChange}
                    className="w-full bg-black/30 border border-cyber-blue/30 rounded-lg px-4 py-3 text-white font-rajdhani placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyber-blue/50 focus:border-cyber-blue transition-all duration-300"
              ...
              <div className="mt-6">
                <label className="block font-rajdhani text-gray-300 mb-2">Adresse</label>
                <textarea
                  name="address"
                  value={formData.address}
                  onChange={handleInputChange}
                  rows="3"
                  className="w-full bg-black/30 border border-cyber-blue/30 rounded-lg px-4 py-3 text-white font-rajdhani placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyber-blue/50 focus:border-cyber-blue transition-all duration-300 resize-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-black/30 border rounded-lg px-4 py-3 text-white font-rajdhani placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-300 ${
                      errors.university ? 'border-red-400 focus:ring-red-400/50' : 'border-purple-400/30 focus:ring-purple-400/50 focus:border-purple-400'
                    }`}
                    placeholder="Université/École"
                  />
                  {errors.university && <span className="text-red-400 text-sm font-rajdhani mt-1 block">{errors.university}</span>}
                </div>
                ...
                <div className="md:col-span-2">
                  <label className="block font-rajdhani text-gray-300 mb-2">Filière/Spécialité *</label>
                  <input
                    type="text"
                    name="field"
                    ...
                    placeholder="Informatique, Ingénierie, Mathématiques..."
                  />
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                >
                  <option value="">Sélectionnez votre niveau</option>
                  <option value="beginner" className="bg-cyber-darkest">Débutant (0-1 an)</option>
                  <option value="intermediate" className="bg-cyber-darkest">Intermédiaire (1-3 ans)</option>
                  <option value="advanced" className="bg-cyber-darkest">Avancé (3+ ans)</option>
                  <option value="expert" className="bg-cyber-darkest">Expert (5+ ans)</option>
                </select>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {interests.map(interest => (
                    <div
                      ...
                      className={`cursor-pointer border rounded-lg px-4 py-3 text-center font-rajdhani text-sm transition-all duration-300 hover:scale-105 ${
            ...
            {/* Motivation */}
            <div>
              <label className="block font-rajdhani text-gray-300 mb-2">
                Pourquoi souhaitez-vous rejoindre AIS ? *
              </label>
              <textarea
                name="motivation"
                ...
                onChange={handleInputChange}
                rows="4"
                className={`w-full bg-black/30 border rounded-lg px-4 py-3 text-white font-rajdhani placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-300 resize-none ${
                  errors.motivation ? 'border-red-400 focus:ring-red-400/50' : 'border-cyber-blue/30 focus:ring-cyber-blue/50 focus:border-cyber-blue'
                }`}
                placeholder="Partagez vos motivations et objectifs..."
              />
              {errors.motivation && <span className="text-red-400 text-sm font-rajdhani mt-1 block">{errors.motivation}</span>}
            </div>
