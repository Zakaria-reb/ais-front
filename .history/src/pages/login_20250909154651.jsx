...
const LoginPage = () => {
  ...
  const demoCredentials = [
    { label: 'Admin', email: 'admin@ais.ensa.ma', password: 'AIS2024!' },
    { label: 'Président', email: 'president@ais.ensa.ma', password: 'President123!' },
    { label: 'Membre', email: 'member@ais.ensa.ma', password: 'Member2024' }
  ];
      ...
      <div className="max-w-6xl w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            {/* Demo Credentials */}
            <div className="bg-black/30 border border-purple-400/20 rounded-2xl p-6 backdrop-blur-sm">
              <h3 className="font-orbitron text-xl font-semibold text-purple-400 mb-4 flex items-center space-x-3">
                <Shield className="w-5 h-5" />
              ...
              <div className="space-y-3">
                {demoCredentials.map((cred, index) => (
                  <div
                    ...
                    className="bg-black/30 border border-gray-600/30 rounded-lg p-4 cursor-pointer hover:border-purple-400/50 hover:bg-purple-400/5 transition-all duration-300 hover:-translate-y-1"
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="font-rajdhani font-semibold text-purple-400 text-sm">{cred.label}</div>
                        <div className="font-fira text-gray-300 text-xs">{cred.email}</div>
                      </div>
                      <div className="text-cyan-400 text-xs font-fira">Click to use</div>
                    </div>
                  </div>
                ))}
              </div>
              <div className="mt-4 p-3 bg-yellow-400/10 border border-yellow-400/30 rounded-lg">
                <p className="font-rajdhani text-yellow-400 text-xs">
                  <strong>Note:</strong> Ces comptes sont uniquement pour la démonstration. 
