          ...
          style={{
            ...
            <div className="flex space-x-8 min-w-max px-8">
              {[
                ...
                { role: "Treasurer", img: "/zakaria.png", name: "[Zakaria Rebbah]", color: "from-yellow-500 to-orange-500" },
                { role: "General Secretary", img: "m2.png", name: "[CLASSIFIED]", color: "from-green-500 to-teal-500" },
                { role: "Head of Media", img: "lina.png", name: "[CLASSIFIED]", color: "from-purple-500 to-pink-500" },
                { role: "Head of Projects", img: "ali.png", name: "[CLASSIFIED]", color: "from-indigo-500 to-blue-500" },
