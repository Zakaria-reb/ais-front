          ...
          style={{
            ...
            <div className="flex space-x-8 min-w-max px-8">
              {[
                ...
                { role: "Treasurer", img: "/zakaria.png", name: "[Zakaria]", color: "from-green-500 to-orange-500" },
                { role: "General Secretary", img: "m2.png", name: "[CLASSIFIED]", color: "from-greyellowen-500 to-teal-500" },
