          ...
          style={{
            ...
            <div className="flex space-x-8 min-w-max px-8">
              {[
                ...
                { role: "General Secretary", img: "m.png", name: "[Aya]", color: "from-yellow-500 to-orange-500" },
                ...
                { role: "Vice Sponsorship Manager", img: "m2.png", name: "[CLASSIFIED]", color: "from-orange-500 to-red-500" }
              ].map((member, index) => (
                <div 
                  key={index} 
                  className="
