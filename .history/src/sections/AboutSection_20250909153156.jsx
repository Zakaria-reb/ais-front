          ...
          style={{
            ...
            <div className="flex space-x-8 min-w-max px-8">
              {[
                ...
                { role: "Sponsorship Manager", img: "/m1.png", name: "[Hiba]", color: "from-orange-500 to-red-500" },
                { role: "Vice Sponsorship Manager", img: "/m2.png", name: "[Aya]", color: "from-orange-500 to-red-500" }
              ].map((member, index) => (
                <div 
                  key={index} 
                  className="
