  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-cyber-dark via-cyber-darker to-cyber-darkest overflow-hidden" id="activities-section">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {activities.map((activity, index) => (
              <div
                key={index}
                className={`group relative bg-black/40 border border-cyber-blue/20 rounded-xl p-8 backdrop-blur-sm hover:border-cyber-blue/40 transition-all duration-700 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyber-blue/20 ${
                  visibleElements.has(`activity-${index}`)
                    ? 'translate-y-0 opacity-100'
                    : 'translate-y-12 opacity-0'
                }`}
                style={{ 
                  transitionDelay: visibleElements.has(`activity-${index}`) ? `${index * 150}ms` : '0ms'
                }}
          ...
          <div 
            ...
            style={{ transitionDelay: visibleElements.has('description') ? '600ms' : '0ms' }}
      ...
      <div className="relative z-10 flex justify-center pb-16">
        <ScrollIndicator
          targetSection="events" // This will scroll to the activities section
