      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center px-6 md:px-12 py-24">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <span className="font-fira text-sm text-bl-400 bg-bl-400/10 px-4 py-2 rounded-full border border-bl-400/30">
              [COMMUNICATION_CHANNEL]
            </span>
          </div>
          <h2 className="font-orbitron text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            <span className="bg-gradient-to-r from-bl-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
              CONTACT US
            </span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-transparent via-bl-400 to-transparent mx-auto"></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {contactMethods.map((method, index) => (
              <div
                key={index}
                className="group bg-black/40 border border-cyber-blue/20 rounded-xl p-6 backdrop-blur-sm hover:border-bl-400/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-bl-400/20"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                {/* Icon */}
                <div className="text-center mb-4">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-bl-500/20 to-cyan-500/20 border border-bl-400/30 group-hover:border-bl-400/50 transition-all duration-300 group-hover:scale-110">
                ...
                <div className="text-center">
                  <h3 className="font-orbitron text-sm font-bold text-bl-400 mb-2 tracking-wider group-hover:text-cyan-400 transition-colors duration-300">
                    {method.label}
                  </h3>
                  <p className="font-rajdhani text-white text-sm mb-2 group-hover:text-bl-100 transition-colors duration-300">
                    {method.value}
                  </p>
                ...
                {/* Hover Effects */}
                <div className="absolute top-2 left-2 w-6 h-0.5 bg-bl-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="absolute top-2 left-2 w-0.5 h-6 bg-bl-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          {/* Call to Action */}
          <div className="text-center">
            <div className="inline-block bg-black/30 border border-bl-400/20 rounded-xl p-6 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <div className="bg-gradient-to-r from-bl-500 to-cyan-500 text-white px-6 py-3 rounded-lg font-rajdhani font-semibold hover:shadow-lg hover:shadow-bl-400/30 transition-all duration-300 cursor-pointer hover:-translate-y-1">
                  Join Now
                </div>
                <div className="border border-bl-400 text-bl-400 px-6 py-3 rounded-lg font-rajdhani font-semibold hover:bg-bl-400/10 transition-all duration-300 cursor-pointer hover:-translate-y-1">
                  Learn More
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-8">
            <div className="inline-flex items-center space-x-3 bg-black/30 border border-bl-400/20 rounded-lg px-6 py-3">
              <div className="w-2 h-2 bg-bl-400 rounded-full animate-pulse"></div>
              <span className="font-fira text-sm text-bl-400">
