  ...
  const events = [
    {
      ...
      image: "/img/hackathon.png", // Your hackathon event image
    ...
    },
    {
      ...
      image: "/img/cyberquest.png", // Your CyberQuest event image
    ...
    },
    {
      ...
      image: "/img/esit-exchange.png", // Your ESIT Exchange event image
    ...
    },
    {
      ...
      image: "/img/it-form.png", // Your IT Form event image
    ...
    },
    {
      ...
      image: "/img/cyber-security.png", // Your Cyber Security event image
    ...
    },
    {
      ...
      image: "/img/atek-talk.png", // Your ATekTalk event image
          ...
          <div className="relative">
            ...
            <div className="space-y-20">
              {events.map((event, index) => (
                <div 
                  key={index} 
                  className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'} transform transition-all duration-1000 ${
                  ...
                  style={{ 
                    transitionDelay: visibleElements.has(`event-${index}`) ? `${600 + index * 200}ms` : '0ms'
                  }}
                ...
                >
                  ...
                  <div className={`w-5/12 ${index % 2 === 0 ? 'pl-8 text-left' : 'pr-8 text-right'}`}>
                    <div 
                      ...
                      style={{ 
                        transitionDelay: visibleElements.has(`date-${index}`) ? `${900 + index * 200}ms` : '0ms'
                      }}
                    >
                      {event.date.split(' ')[0]}
